...
String getIzinCutiStatusLocale(IzinCutiStatus status, BuildContext context) {
  switch (status) {
...
class CutiLogFilterPage extends StatefulWidget {
  final CutiFilterData filterData;

  const CutiLogFilterPage({
    super.key,
    required this.filterData,
  });

  @override
  State<CutiLogFilterPage> createState() => _CutiLogFilterPageState();
}

class _CutiLogFilterPageState extends State<CutiLogFilterPage> {
  ...
  Widget build(BuildContext context) {
    return StandardPage(
      appBar: Header(
        ...
        subtitle: Text('Riwayat Izin/Cuti'),
        leading: IconButton(
          onPressed: () {
      ...
      children: [
        ...
        ParagraphSection(
          ...
          content: Wrap(
            ...
            runSpacing: 4,
            children: [
              for (final status in IzinCutiStatus.values)
                ToggledChip(
