...
|
*/
//$config['base_url'] = 'https://office.suryaenergi.my.id/';
...
$config['sess_save_path'] = "sei_sessions";
...
$config['csrf_token_name'] = 'csrf_sei_office_token';
$config['csrf_cookie_name'] = 'csrf_sei_office';
