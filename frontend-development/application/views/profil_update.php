    ...
    <div class="row">
        ...
        <div class="card card-info">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" name="statusdarurat" class="form-control" required placeholder="STATUS TELP DARURAT" value="<?php echo $profil->no_telp_darurat; ?>">
            </div>
          </div>
        </div>
      ...
      <div class="col-md-6">
        ...
        <div class="card card-warning">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <?php echo form_error('bankbranch','<div class="alert alert-warning">','</div>'); ?>
              <input type="text" name="bankbranch" class="form-control" disabled placeholder="Bank Branch" value="<?php echo $profil->bank_branch; ?>">
            </div>          
            <div class="form-group">
              <label for="exampleInputEmail1">Bank Account</label>
              <?php echo form_error('bankaccount','<div class="alert alert-warning">','</div>'); ?>
              <input type="text" name="bankaccount" class="form-control" disabled placeholder="Bank Account" value="<?php echo $profil->bank_account; ?>">
            </div>
            <div class="form-group">
              <label for="exampleInputEmail1">Bank Branch 2</label>
              <?php echo form_error('bankbranch2','<div class="alert alert-warning">','</div>'); ?>
              <input type="text" name="bankbranch2" class="form-control" disabled placeholder="Bank Branch 2" value="<?php echo $profil->bank_branch2; ?>">
            </div>
          
            <div class="form-group">
              <label for="exampleInputEmail1">Bank Account 2</label>
              <?php echo form_error('bankaccount2','<div class="alert alert-warning">','</div>'); ?>
              <input type="text" name="bankaccount2" class="form-control" disabled placeholder="Bank Account 2" value="<?php echo $profil->bank_account2; ?>">
            </div>
          </div>
        ...
        <div class="card card-primary">
          ...
          <div class="card-header">
            <h3 class="card-title">DYNAMICS 365 BC</h3>
          </div>
          <!-- /.card-header -->

          <div class="card-body">
            <div class="form-group">
              <label for="exampleInputEmail1">Person ID Mesin Absen</label>
              <?php echo form_error('personid','<div class="alert alert-warning">','</div>'); ?>
              <input type="text" name="personid" class="form-control" disabled placeholder="Person ID Mesin Absen" value="<?php echo $profil->person_id_mesin_absen; ?>">
            </div>          
            <div class="form-group">
              <label for="exampleInputEmail1">User ID Login</label>
              <?php echo form_error('useridlogin','<div class="alert alert-warning">','</div>'); ?>
              <input type="text" name="useridlogin" class="form-control" disabled placeholder="User ID Login" value="<?php echo $profil->user_id_nav; ?>">
            </div>
            <div class="form-group">
              <label for="exampleInputEmail1">Atasan User ID Login</label>
              <?php echo form_error('atasanuseridlogin','<div class="alert alert-warning">','</div>'); ?>
              <input type="text" name="atasanuseridlogin" class="form-control" disabled placeholder="Atasan User ID Login" value="<?php echo $profil->atasan_user_id; ?>">
            </div>
          </div>
