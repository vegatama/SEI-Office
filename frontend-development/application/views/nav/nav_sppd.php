...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-9">
        <h1 class="m-0">Perjalanan Dinas</h1>
      </div><!-- /.col -->
      <div class="col-sm-3">
      ...
      <div class="col-md-12">
        <div class="card card-warning">
          <div class="card-header">
            <h3 class="card-title"><i class="fas fa-file-invoice"></i> Perjalanan Dinas Need Approve</h3>
          </div>
          <div class="card-body">
            ...
            <table id="nav" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <td><?php echo $dt->Untuk_Keperluan; ?></td>
                <td><?php echo $dt->Status; ?></td>
                <td><?php echo $dt->Need_Approve_User_Id; ?></td>
                <th><a class="btn btn-success btn-sm" href="<?php echo site_url('nav/sppddetail/'.$dt->No); ?>">
                              <i class="fas fa-info">
                              </i>
                              Detail
                          </a></th>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title"><i class="fas fa-file-invoice"></i> Perjalanan Dinas Approved</h3>
          </div>
          <div class="card-body">
            ...
            <table id="nava" class="table table-bordered table-striped">
              ...
              <?php 
                if(isset($sppda)):
                foreach($sppda as $dta) : 
              ?>
              <tr>
                <td><?php echo $dta->No; ?></td>
                <td><?php echo $dta->Kode_Kegiatan; ?></td>
                <td><?php echo $dta->Untuk_Keperluan; ?></td>
                <td><?php echo $dta->Status; ?></td>
                <td><?php echo $dta->Need_Approve_User_Id; ?></td>
                <th><a class="btn btn-success btn-sm" href="<?php echo site_url('nav/sppddetail/'.$dta->No."/app"); ?>">
                              <i class="fas fa-info">
                              </i>
                              Detail
                          </a></th>
