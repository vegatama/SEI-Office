    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-3">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">DPB</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
      ...
      <div class="col-md-12">
        <div class="card card-warning">
          <div class="card-header">
            <h3 class="card-title"><i class="fas fa-file-invoice"></i> Daftar Pembelian Barang Need Approve</h3>
          </div>
          <div class="card-body">
            ...
            <table id="nav" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <th><a class="btn btn-success btn-sm" href="<?php echo site_url('nav/dpbdetail/'.$dt->No); ?>">
                              <i class="fas fa-info">
                              </i>
                              Detail
                          </a></th>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title"><i class="fas fa-file-invoice"></i> Daftar Pembelian Barang Approved</h3>
          </div>
          <div class="card-body">
            ...
            <table id="nava" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <th><a class="btn btn-success btn-sm" href="<?php echo site_url('nav/dpbdetail/'.$dta->No."/app"); ?>">
                              <i class="fas fa-info">
                              </i>
                              Detail
                          </a></th>
