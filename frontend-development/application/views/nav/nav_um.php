...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-9">
        <h1 class="m-0">Permohona Uang Muka</h1>
      </div><!-- /.col -->
      <div class="col-sm-3">
      ...
      <div class="col-md-12">
        <div class="card card-warning">
          <div class="card-header">
            <h3 class="card-title"><i class="fas fa-file-invoice"></i> Uang Muka Need Approve</h3>
          </div>
          <div class="card-body">
            ...
            <table id="nav" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <th><a class="btn btn-success btn-sm" href="<?php echo site_url('nav/umdetail/'.$dt->Nomor); ?>">
                              <i class="fas fa-info">
                              </i>
                              Detail
                          </a></th>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card card-primary">
          <div class="card-header">Uang Muka Approved</h3>
          </div>
          <div class="card-body">
            ...
            <table id="nava" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <th><a class="btn btn-success btn-sm" href="<?php echo site_url('nav/umdetail/'.$dta->Nomor."/app"); ?>">
                              <i class="fas fa-info">
                              </i>
                              Detail
                          </a></th>
